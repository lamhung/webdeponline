...
define ('CACHE_MAX_AGE', 86400000);			// time to cache in the browser
define ('VERSION', '1.30');					// version number (to force a cache refresh)
define ('DIRECTORY_CACHE', './cache');		// cache directory
define ('MAX_WIDTH', 15000000);					// maximum image width
define ('MAX_HEIGHT', 15000000);				// maximum image height
