...
<form class="form-horizontal" enctype="multipart/form-data" method="post" autocomplete="on">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 grid_box1">
            ...
            <?php if(isset($this->config_img) && $this->config_img  == 'true') {?>
            ...
            <?php } ?>
            <?php if(isset($this->config_desc) && $this->config_desc  == 'true') {?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11">
                    ...
                    <fieldset style="border:1px solid #CCC;" dir="rtl" >
                        ...
                        <iframe name="image_iframe" id="image_iframe" width="100%" scrolling="yes" frameborder="0" style="min-height:200px" src="<?php echo base_url('acp/image?table_name=sigle_post&table_id='.$row['id'].'&type=post');?>"></iframe>
                     </fieldset>
                </div>
            </div><!-- /Form group-->
            <div class="form-group ">
            ...
            <div class="form-group">
                <label for="status" class="col-sm-1 control-label"><?php echo $this->lang->line('status') ?></label>
                <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-md-offset-5">
                    ...
                    <a href="<?php echo base_url('acp/single_post/show/'.$row["id"].'?type='.$this->type); ?>" class="btn btn-warning btn-md"><?php echo $this->lang->line('btn_show') ?></a>
