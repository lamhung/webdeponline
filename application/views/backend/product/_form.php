...
<form class="form-horizontal" enctype="multipart/form-data" method="post" autocomplete="on">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 grid_box1">
            <?php  if($this->config_list == "true"){?>
            <div class="form-group <?php if (form_error('list_id')) echo 'has-error'; ?>"">
                <label for="list_id" class="col-sm-2 control-label"><?=$this->lang->line('category'); ?> 1</label>
                <div class="col-sm-8">
            ...
            <?php } ?>
            <?php  if($this->config_cat == "true"){?>
            <div class="form-group <?php if (form_error('cat_id')) echo 'has-error'; ?>"">
                <label for="cat_id" class="col-sm-2 control-label"><?=$this->lang->line('category'); ?> 2</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label"><?=$this->lang->line('image_attach');?></label>
                <div class="col-sm-10">
                    <fieldset style="border:1px solid #CCC;" dir="rtl" >
                        ...
                        <iframe name="image_iframe" id="image_iframe" width="100%" scrolling="yes" frameborder="0" style="min-height:200px" src="<?php echo base_url('acp/image?table_name=product&table_id='.$row['id'].'&type=product');?>"></iframe>
                     </fieldset>
                </div>
            </div><!-- /Form group-->
            <div class="form-group <?php if (form_error('price')) echo 'has-error'; ?>">
                <label for="price" class="col-sm-2 control-label "><?php echo $this->lang->line('product_price') ?></label>
                <div class="col-sm-8">
            ...
            <div class="form-group <?php if (form_error('old_price')) echo 'has-error'; ?>">
                <label for="old_price" class="col-sm-2 control-label "><?php echo $this->lang->line('product_old_price') ?></label>
                <div class="col-sm-8">
            ...
            <?php  if($this->config_hosting == "true"){?>
            <!-- Form group-->
            <div class="form-group <?php if (form_error('dungluong')) echo 'has-error'; ?>">
                <label for="name" class="col-sm-2 control-label ">Dung lượng(MB)</label>
                <div class="col-sm-8">
                    <input class="form-control1" name="dungluong" id="dungluong" placeholder="Enter Dung lượng" type="text" value="<?php echo set_value('dungluong', $row['dungluong']) ?>">
                    <?php echo form_error('dungluong', "<small class='help-block'>", '</small>'); ?>
                </div>
            </div><!-- /Form group-->
            <!-- Form group-->
            <div class="form-group <?php if (form_error('bangthong')) echo 'has-error'; ?>">
                <label for="name" class="col-sm-2 control-label ">Băng thông(Gb)</label>
                <div class="col-sm-8">
                    <input class="form-control1" name="bangthong" id="bangthong" placeholder="Enter Băng thông" type="text" value="<?php echo set_value('bangthong', $row['bangthong']) ?>">
                    <?php echo form_error('bangthong', "<small class='help-block'>", '</small>'); ?>
                </div>
            </div><!-- /Form group-->
            <?php } ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <fieldset style="border:1px solid #CCC;" dir="rtl" >
                        <legend style="font-size:14px;  padding:0 10px 0 10px;"> Chỉ tải lên các hình có định dạng là <strong>jpg | png | gif</strong> và không vượt quá 5MB</legend>
                        <iframe name="image_iframe" id="image_iframe" width="100%" scrolling="yes" frameborder="0" style="min-height:200px" src="<?php echo base_url('acp/image?table_name=product&table_id='.$row['id'].'&type=post');?>"></iframe>
                     </fieldset>
                </div>
            </div><!-- /Form group-->
            <div class="form-group ">
...
//        var cat_id = $("#cat_id").val();
    ...
    function load_cat(list_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url('acp/product/ajax_load_cate?type=' . $type); ?>",
