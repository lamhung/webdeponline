<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAL928AIsIDYz9oUb-ILO5LTe_7MQnVgDA"></script>
			...
			<script>
				function initialize() {
					...
					var map = new google.maps.Map(document.getElementById('map_canvas1111'), mapOptions);
			...
			<div id="map_canvas1111" style="width: 90%; height: 190px;margin: auto;padding-top: 10px;"></div>
